...
class RouteGuideSerializer(WritableNestedModelSerializer):
    ...
    rg_verification_record = VerificationRecordSerializer(required=False)
    ...
    rg_gradient = RouteGradientSerializer(required=False, allow_null=True)
    rg_difficulty = RouteDifficultySerializer(many=True, required=False)
    rg_risk_advisory = RouteRiskAdvisorySerializer(required=False, allow_null=True)
    rg_legal_advisory = RouteLegalAdvisorySerializer(required=False, allow_null=True)
